    ...
    <hr>
        ...
        <form action="/showResults" method="post">
            ...
            <div class="d-flex" style="width:100%;align-items:center;justify-content:center;">
                <button type="submit" class="btn" style="margin-right:15px;">Proveri stavka</button>
        ...
        @endif
           ...
           @if($user->isAdministrator())
                ...
                <h1>Korisnici sto cekaat da bidat potvrdeni</h1>
